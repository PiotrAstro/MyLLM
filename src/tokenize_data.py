...
TOKENIZED_SAFE_PATH = pathlib.Path("data", "dataopenwebtext","tokenized_dataopenwebtext_32768.npy")
TOKENIZER_PATH = pathlib.Path("results", "tokenizer_dataopenwebtext_32768.txt")
